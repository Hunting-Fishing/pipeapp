...
Baseline branch: `agent/persisted-saved-listings`
Created: July 20, 2026

Current gate: Gate 1 — Reproducible environments, builds, and diagnostics

Current overall launch-readiness estimate: 45%
...
| 2 — Backend parity and server commands | 66% — local integration verified |
| 3 — Identity, authorization, and abuse | 10% — incomplete |
| 4 — Product workflows | 39% — saved and listing lifecycle locally verified |
...
- Release manifests declare the exact 32 expected Function exports
...
- Auth, Firestore, and Functions emulator integration verifies 24 command
