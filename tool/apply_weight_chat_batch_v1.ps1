...
try {
  Write-Step 'Applying server/schema weight policy'
  & node '.\tool\patch_weight_server_v1.mjs'
  ...
  if ($hasChanges) {
    git commit -m 'Add listing weight snapshots and improve carrier quote media UX'
