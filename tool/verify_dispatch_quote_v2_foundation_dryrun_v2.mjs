...
for (const retired of [
  ...
  if (transformed.dashboard.includes(retired)) {
    throw new Error(`STOP: Dashboard candidate still contains retired Quote V1 code: ${retired}`);
  }
}
...
console.log('PIPE BUYER DISPATCH QUOTE V2 DRY-RUN V2 PASSED');
console.log('Exact local source recognized: PASS');
console.log('Legacy Jobs all-in quote dialog removed in candidate: PASS');
console.log('Retired Dashboard quote editor pruned in candidate: PASS');
