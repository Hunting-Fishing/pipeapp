...
$expectedPageBlob = '9ba9e7c0fd8ff274bf7bf16628213fff24687641'
...
Write-Step 'Checking the direct page exposes only the four core sections'
...
foreach ($requiredText in @(
  ...
  if (-not $pageSource.Contains($requiredText) -and
      -not $navigationSource.Contains($requiredText)) {
