...
IconData _dispatchServiceIcon(String service) => _dispatchServices
    .firstWhere((item) => item.name == service,
...
class _PilotTruckSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      ListView(padding: const EdgeInsets.all(18), children: [
        const Text('Pilot Truck Services',
                    ...
                    child: Padding(
                        ...
                        child: Row(children: [
                          IndustrialAssetIcon(
                              ...
                              size: 64,
                              fallback: Icon(Icons.assistant_direction_outlined,
                                  size: 38)),
                          SizedBox(width: 12),
                          Expanded(
                              child: Column(
...
class _JobBoardState extends State<_JobBoard> {
                  ...
                  if (jobs.isEmpty) {
                    return const Center(
                      ...
                      IndustrialAssetIcon(
                          ...
                          size: 108,
                          fallback: Icon(Icons.local_shipping_outlined,
                              size: 56, color: Color(0xFF0878E8))),
                      SizedBox(height: 12),
                      Text('No open trucking jobs yet.',
            ...
            child: SizedBox(
                ...
                child: Column(children: [
                  ListTile(
                      ...
                      title: const Text('My Dispatch request history',
                          style: TextStyle(
                              fontSize: 20, fontWeight: FontWeight.w900)),
                      subtitle:
                          const Text('Open, awarded and completed requests'),
                      trailing: IconButton(
                          tooltip: 'Close',
                  ...
                  Expanded(
                      child: jobs.isEmpty
                          ? const Center(
                              child: Text('No Dispatch requests yet.'))
                          : ListView(
            ...
            child: SizedBox(
                ...
                child: Column(children: [
                  ListTile(
                      ...
                      title: const Text('My carrier quote history',
                          style: TextStyle(
                              fontSize: 20, fontWeight: FontWeight.w900)),
                      subtitle:
                          const Text('Pending, awarded and archived quotes'),
                      trailing: IconButton(
                          tooltip: 'Close',
                          onPressed: () => Navigator.pop(sheetContext),
                          icon: const Icon(Icons.close))),
                                ...
                                return Card(
                                    child: ListTile(
                                        ...
                                        trailing:
                                            const Icon(Icons.chevron_right),
                                        onTap: () async {
                                          final job = await FirebaseFirestore
                                              .instance
                                              .collection('dispatch_jobs')
                                              .doc('${data['jobId']}')
                                              .get();
  ...
  Future<void> _showJobManager(
      BuildContext context, DocumentSnapshot<Map<String, dynamic>> job) async {
            ...
            child: Padding(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ListTile(
                      ...
                      title: Text('${data['title'] ?? 'Dispatch request'}',
                          style: const TextStyle(
                  ...
                  Row(children: [
                    Expanded(
                        child: OutlinedButton.icon(
                            onPressed:
                                ['draft', 'open'].contains(data['status'])
                                    ? () {
                                        Navigator.pop(sheetContext);
                  ...
                  FilledButton.icon(
                      ...
                      label:
                          Text('View carrier bids (${data['bidCount'] ?? 0})'),
  ...
  Future<void> _editJob(
    ...
    final delivery =
        TextEditingController(text: '${data['deliveryLabel'] ?? ''}');
    ...
    final saved = await showDialog<bool>(
        ...
        false;
    if (!saved) return;
    if ([title, pickup, delivery, details]
                    ...
                    builder: (_, snapshot) {
                      ...
                      return Column(children: [
                        ...
                        Expanded(
                            child: bids.isEmpty
                                ? const Center(
                                    child: Text('No carrier bids yet.'))
                                : ListView(
                                    children: bids.map((bid) {
                                    final data = bid.data();
                                    return Card(
                                                                  ...
                                                                  builder: (dialogContext) =>
                                                                      AlertDialog(
                                                                          title: const Text(
                                                                              'Select this carrier?'),
                                                                          content:
                                                                              const Text('The carrier will be notified and this dispatch job will close to new bids.'),
                                                                          actions: [
                                                                            TextButton(
  ...
  Future<void> _openCarrierJob(BuildContext context,
      QueryDocumentSnapshot<Map<String, dynamic>> job) async {
  ...
  Future<void> _showCarrierQuote(
      ...
      QueryDocumentSnapshot<Map<String, dynamic>> bid) async {
            ...
            child: Padding(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ListTile(
                      contentPadding: EdgeInsets.zero,
                      leading: const Icon(Icons.request_quote_outlined,
                          color: Color(0xFF0878E8), size: 36),
                      title: const Text('Your carrier quote',
                          style: TextStyle(
                              fontSize: 20, fontWeight: FontWeight.w900)),
                      subtitle: Text(
                  ...
                  Card(
                      ...
                      child: ListTile(
                          ...
                          isThreeLine: true,
                          trailing: Chip(
                              label: Text('REV ${data['revision'] ?? 1}')))),
                  Row(children: [
                    Expanded(
                        child: OutlinedButton.icon(
  ...
  Future<void> _bid(BuildContext context, String id, Map<String, dynamic> data,
    ...
    var selectedVehicle = fleet.docs
        ...
        fleet.docs.first;
    final amount =
        TextEditingController(text: '${existingData?['amount'] ?? ''}');
                              ...
                              items: fleet.docs.map((vehicle) {
                                ...
                                return DropdownMenuItem(
                                    ...
                                    child: MarketplaceFormOption(
                                        label:
                                            '${vehicleData['name'] ?? 'Fleet vehicle'}',
                                        subtitle:
                                            '$vehicleType • ${vehicleData['maximumPayloadKg'] ?? 0} kg payload',
                                        icon: _vehicleTypeFallbackIcon(
                                            vehicleType),
                                        assetPath:
            ...
            builder: (dialogContext) => AlertDialog(
                    ...
                    actions: [
                      ...
                      FilledButton(
                          onPressed: () => Navigator.pop(dialogContext, true),
                          child: Text(
                              existing == null ? 'Submit bid' : 'Save quote'))
                    ])) ??
        false;
    if (confirmed) {
      await repo.bid(
...
class _PostJobState extends State<_PostJob> {
  ...
  Widget build(BuildContext context) =>
      ListView(padding: const EdgeInsets.all(18), children: [
        const Text('Post a trucking job',
        ...
        Card(
            ...
            child: ListTile(
                ...
                title: const Text('Select a listing for quote',
        ...
        const Padding(
            ...
            child: Row(children: [
              ...
              Padding(
                  ...
                  child: Text('OR ENTER A LOAD MANUALLY',
                      style:
                          TextStyle(fontSize: 11, color: Color(0xFF66758A)))),
              Expanded(child: Divider())
            ])),
        Form(
            key: form,
              ...
              for (final field in [
                ...
                TextFormField(
                    ...
                    decoration: InputDecoration(
                        labelText: '${field.$2} *', prefixIcon: Icon(field.$3)),
                    validator: (v) =>
              ...
              FilledButton.icon(
                  onPressed: () async {
                    ...
                    if (context.mounted) {
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text(
                              'Dispatch job published for carrier bids.')));
                    }
                  },
                          ...
                          child: ListView(
                              children: listings
                                  .map((doc) => ListTile(
                                      ...
                                      trailing: const Icon(Icons.chevron_right),
                                      onTap: () =>
                                          Navigator.pop(sheetContext, doc)))
                                  .toList()))
                    ]))));
      ...
      StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
            ...
            return ListView(padding: const EdgeInsets.all(18), children: [
              Text(signedUp ? 'Dispatch account' : 'Dispatch Signup',
                  style: const TextStyle(
  ...
  Widget _signupForm() => Form(
      ...
      child: Column(children: [
        ...
        ListTile(
            ...
            onTap: () async {
              final value =
                  await MarketplaceServiceAreaPicker.show(context, area);
                  ...
                  child: Column(children: [
                    ListTile(
                        ...
                        leading: IndustrialAssetIcon(
                            ...
                            size: 42,
                            borderRadius: 10,
                            fallback: Icon(_vehicleTypeFallbackIcon(
                                '${data['vehicleType'] ?? 'Truck'}'))),
                        title: Text('${data['name'] ?? 'Fleet vehicle'}',
                            style:
                        ...
                        child: Wrap(
                            ...
                            children: services
                                .map((service) => Chip(
                                    ...
                                    avatar: Icon(_dispatchServiceIcon(service),
                                        size: 17),
                                    label: Text(service)))
                                .toList()))
                  ])));
                            ...
                            child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  Builder(builder: (_) {
                                    ...
                                    final registered =
                                        num.tryParse(gross.text) ?? 0;
                                    final rated =
                                        num.tryParse(capacity.text) ?? 0;
                                    final calculated = (registered - empty)
                                  ...
                                  TextField(
                                      ...
                                      decoration: const InputDecoration(
                                          labelText:
                                              'Capabilities or notes (optional)',
                                          prefixIcon:
                                              Icon(Icons.notes_outlined)))
                                ]))),
                        actions: [
