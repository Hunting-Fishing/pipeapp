...
class _MarketplacePublicProfilePageState
  ...
  Query<Map<String, dynamic>> _listingQuery() => FirebaseFirestore.instance
      ...
      .where('status', whereIn: const ['active', 'published'])
  ...
  Future<_PublicProfileData> _load() async {
    ...
    final tagDocuments = await Future.wait(
      tagIds
          .take(30)
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: FutureBuilder<_PublicProfileData>(
      ...
      builder: (context, snapshot) {
        ...
        final profile = data.business.isNotEmpty
            ? data.business
            : data.personal;
        final name =
            '${data.business['publicName'] ?? data.personal['displayName'] ?? widget.fallbackName}'
                .trim();
        final description = '${profile['description'] ?? 'Marketplace member'}'
            .trim();
        final location =
              ...
              children: [
                _StorefrontHero(
                  ...
                  onEdit: isOwnProfile
                      ? () => Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (_) => const MarketplaceProfilePage(),
                          ),
                        )
                      : null,
                ),
                ...
                PipeBuyerMetricGrid(
                  children: [
                    PipeBuyerMetricCard(
                      ...
                      value: '$loadedListings${_hasMoreListings ? '+' : ''}',
                ...
                LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    final contact = PipeBuyerSectionCard(
                      ...
                      leading: const _SectionIcon(Icons.contact_phone_outlined),
                      child: Column(
                        children: [
                          ...
                          if (publicPhone.isNotEmpty &&
                              (publicEmail.isNotEmpty || website.isNotEmpty))
                    ...
                    if (!wide) {
                      return Column(
                        children: [about, const SizedBox(height: 12), contact],
                      );
                    }
                    return Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                ...
                if (_listings.isEmpty)
                  ...
                  _ListingsGrid(documents: _listings, sellerName: name),
                ...
                if (_hasMoreListings) ...[
                  ...
                  Align(
                    ...
                    child: OutlinedButton.icon(
                      onPressed: _loadingMoreListings
                          ? null
                          : _loadMoreListings,
                    ...
                    Expanded(
                      child: OutlinedButton.icon(
                        onPressed: () => context.push(
                          MarketplaceDeepLinks.listing(document.id),
                        ),
