...
class _MarketplaceAccountSecurityPageState
                ...
                PipeBuyerMetricGrid(
                  children: [
                    ...
                    PipeBuyerMetricCard(
                      ...
                      caption: _mfaEnrolled
                          ? '+20 points earned'
                          : '+20 optional protection points',
                      tone: _mfaEnrolled
                          ? PipeBuyerStatusTone.success
  ...
  Widget _trustReadinessExplanation() => KeyedSubtree(
        key: _readinessKey,
  ...
  Widget _identitySection(User user) => PipeBuyerSectionCard(
        ...
        leading: Container(
          ...
          child:
              const Icon(Icons.badge_outlined, color: PipeBuyerColors.orange),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
            ...
            if (_mfaSupported && !_mfaEnrolled) ...[
              ...
              if (!_emailVerified || !_phoneVerified)
                ...
                FilledButton.icon(
                  ...
                  label: Text(_busy
                      ? 'Preparing…'
                      : 'Enable SMS two-step verification'),
                )
              else ...[
                TextField(
                  controller: _mfaCode,
