...
async function main() {
  ...
  const listings = {
    ...
    "visual-auction-dozer": sellerListing("visual-auction-dozer", {
      ...
      auctionQuantity: 1,
      bidCount: 8,
      highBidderUid: "visual-carrier",
      currentBidId: "visual-auction-bid-008",
      auctionStatus: "active",
      auctionStartAt: atDays(-1),
      auctionEndAt: atHours(5),
      condition: "Good",
      description: "Live visual-sandbox Timed Buying listing with authenticated member activity and a closing-time urgency state.",
      ageDays: -1,
    }),
